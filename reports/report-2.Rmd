...
```{r enrolments plots, echo=FALSE, out.width = "100%", fig.width=9,fig.height=4.5 , fig.cap= "Plots of number of enrollments (left) and percentage of participants completing the course (right) for all 7 runs"}
...
``` {r barplots_gender_all_participants, fig.width = 14, fig.height = 8, fig.cap = "Gender statistics for participants enrolled in runs 4-7" , echo = FALSE}
...
However it would be interesting to also investigate whether there were differences in gender among the people that completed the course. 

``` {r barplots gender completed , fig.width = 14, fig.height = 8, fig.cap = "Gender statistics for participants that completed in runs 4-7" , echo = FALSE}
par(mfrow = c(2, 2))
...
```{r barplots age range all participants, echo=FALSE, fig.width = 15, fig.height = 11, fig.cap="Age statistics for participants enrolled in runs 4-7" }
par(mfrow = c(2, 2))
...
```{r barplots age range complete participants, echo=FALSE, fig.width = 15, fig.height = 9, fig.cap="Age statistics for participants enrolled in runs 4-7"}
par(mfrow = c(2, 2))
...
```{r plot engagement over 7 runs, fig.width = 20, fig.height = 28, echo=FALSE, fig.cap="Plots of step number against number of people who engaged in each step (solid line) and people who engaged and finished the step (dashed line) for all 7 runs"}
par(mfrow = c(4, 2))
...
knitr::kable(df_quiz_step, "simple", caption = "Table showing the quiz number and the number of question it contains")
```
...
In order to investigate that the figure 7 is produced: 

``` {r cor plots for quiz and engagement, fig.width = 20, fig.height = 28, echo = FALSE, fig.cap = "Plots showing the relationship of quiz/test length against engagement over all 7 runs"}
par(mfrow = c(4, 2))
...
```{r ggplot for vid stats run 4, echo=FALSE, fig.width= 20, fig.height=8, out.width="115%", fig.align = "left", fig.cap="Percentage of people engaging with each video in run 4" }
# RUN 4
...
```{r ggplot for vid stats run 5, echo=FALSE, fig.width= 20,fig.height=8,  out.width="115%", fig.align = "left", fig.cap="Percentage of people engaging with each video in run 5" }
# RUN 5 
...
```{r ggplot for vid stats run 6, echo=FALSE, fig.width= 20,fig.height=8,  out.width="115%", fig.align = "left", fig.cap="Percentage of people engaging with each video in run 6" }
# RUN 6
...
```{r ggplot for vid stats run 7, echo=FALSE, fig.width= 20,fig.height=8,  out.width="115%", fig.align = "left", fig.cap="Percentage of people engaging with each video in run 7" }
# RUN 7 
...
knitr::kable(video_duration_4, "simple", caption = "Table showing the video number and it's corresponding duration")
```
...
```{r corr plots video engagement, fig.width = 15, fig.height = 18, echo = FALSE, fig.cap = "Plots showing the relationship between video duration and engagement over all 7 runs"}
par(mfrow = c(2, 2))
# RUN 4 
...
```{r barplot video engagement, echo=FALSE, fig.width= 14, fig.height=10, fig.cap=" Barplot of percentage of people that droped out of each video for runs 4-7"}
# RUN 4
...
The first observation, from figure 14, that is common for all runs is that video 1.5, which has duration of 281 seconds, has the largest dropout rate among all videos in week 1 and all videos in general. Then for week 2 video 2.11, which has duration of 312 seconds, has the largest dropout and for week 3
