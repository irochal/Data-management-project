...
abline(lm(cyber.security.3_video.stats$video_duration ~ cyber.security.3_video.stats$viewed_onehundred_percent),
       lty = 2 , col = "red")

cor(cyber.security.3_video.stats$viewed_onehundred_percent, cyber.security.3_video.stats$video_duration)
